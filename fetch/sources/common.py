...
def is_relevant_area_notam(message: str) -> bool:
    ...
    is_relevant = (
        ...
        or ('SPACEX' in text and 'LAUNCH' in text)
        or ('SPACEX' in text and 'REENTRY' in text)
        or ('SPACEX' in text and 'RETURN' in text)
        or ('SPACEX' in text and 'RE-ENTRY' in text)
        or ('SPACEX' in text and 'SPLASHDOWN' in text)
        or ('SPACEX' in text and 'STARSHIP' in text)
        or ('SPACEX' in text and 'STARLINK' in text)
        or ('SPACEX' in text and 'DEBRIS' in text)
