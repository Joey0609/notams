...
def is_relevant_aerospace_area(message: str, *, require_full_altitude: bool) -> bool:
    ...
    is_relevant = (
        (require_full_altitude and 'A TEMPORARY' in text and '-' in text)
        ...
        or ('火箭' in text and '发射' in text)
        or ('火箭' in text and '残骸' in text)
        or ('火箭' in text and '返回' in text)
        or ('火箭' in text and '回收' in text)
        or ('火箭' in text and '回收区' in text)
    )
    not_relevant = (
        ('MISSILE' in text)
