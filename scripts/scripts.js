...
function drawLaunchsite(siteX, siteY, iW) {
    ...
    var myIcon = new BMap.Icon("statics/launch.png", new BMap.Size(33, 40), { anchor: new BMap.Size(16.5, 20), imageOffset: new BMap.Size(0, 0) });
...
function drawLaunchsite1(siteX, siteY, iW) {
    var point = new BMap.Point(siteX, siteY);
    var myIcon = new BMap.Icon("statics/launch1.png", new BMap.Size(28, 28), { anchor: new BMap.Size(14, 14), imageOffset: new BMap.Size(0, 0) });
    var marker = new BMap.Marker(point, { icon: myIcon });
    map.addOverlay(marker);
    marker.addEventListener("click",
        function () {
